...
var PSetupForm_module_css_1 = require("./PSetupForm.module.css");
...
function PSetupForm() {
    ...
    return (react_1["default"].createElement(react_1["default"].Fragment, null,
        react_1["default"].createElement("div", { className: PSetupForm_module_css_1["default"].container },
            react_1["default"].createElement("form", { onSubmit: formik.handleSubmit, autoComplete: "off" },
                react_1["default"].createElement("div", { className: PSetupForm_module_css_1["default"].containerContent },
                    react_1["default"].createElement("div", { className: PSetupForm_module_css_1["default"].contentWrapper },
                        react_1["default"].createElement("div", { className: PSetupForm_module_css_1["default"].headerContent },
                            react_1["default"].createElement("div", { className: PSetupForm_module_css_1["default"].headerTexts },
                                react_1["default"].createElement("div", { className: PSetupForm_module_css_1["default"].headerOne },
                                    react_1["default"].createElement(Typography_1["default"], { sx: headerOne, variant: "h6" }, "Setup your profile")),
                                react_1["default"].createElement("div", null,
                                    react_1["default"].createElement(Typography_1["default"], { sx: headerMsg }, "Please fill in your details to create your profile")))),
                        react_1["default"].createElement("div", { className: PSetupForm_module_css_1["default"].formContainer },
                            ...
                            react_1["default"].createElement(Grid_1["default"], { container: true, columnSpacing: 2 },
                                react_1["default"].createElement(Grid_1["default"], { item: true, xs: 3, sm: 2 },
                                    react_1["default"].createElement(TextField_1["default"], { sx: ccStyles, id: "phone", name: "phone", size: "small", variant: "outlined", placeholder: "+234" })),
                            ...
                            react_1["default"].createElement("div", null,
                                react_1["default"].createElement(CustomButton_1["default"], { type: "submit", color: "primary", size: "small", variant: "contained", sx: buttonStyles, fullWidth: true },
                                    react_1["default"].createElement(Typography_1["default"], null,
                                        react_1["default"].createElement(Box_1["default"], { sx: { textTransform: "capitalize" } }, "Proceed")))))))))));
}
exports["default"] = PSetupForm;
